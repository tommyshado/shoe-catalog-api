export default function shoesService(db) {
    ...
    async function addOrUpdateShoe({ name, color, brand, price, size, in_stock, image_url }) {
      ...
      console.log('Existing shoe:', existingShoe);  // Debugging line
    
      if (existingShoe) {
        console.log('Updating existing shoe');  // Debugging line
        // If it exists, update only the stock
        ...
        console.log('Inserting new shoe');  // Debugging line
