...
describe("Shoe Services", function () {
  ...
  beforeEach(async function () {
      ...
      // Insert a user record for the tests (assuming your users table has a username and password)
      await db.none('INSERT INTO "public"."users"(username, password) VALUES($1, $2)', ['testuser', 'testpass']);
